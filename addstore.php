...
<div class="card text-white" style="background-color:rgba(74, 74, 177, 0.46);">
    ...
    <form action="Controller/savestore.php" method="POST">
    <div class="card-body">
	
	<div class="form-group form-row">
        <label class="col-md-4">Name</label>
		<input type="text" name="s_name" class="form-control col-md-8" pattern="[A-Za-z]+" title="letters only" required>
	</div>

	<div class="form-group form-row">
        <label class="col-md-4">Address</label>
		<input type="text" name="s_address" class="form-control col-md-8" >
	</div>
<div class="form-group form-row">
        <label class="col-md-4">Contact</label>
        <input type="text" name="s_contact" class="form-control col-md-8" >
	</div>
